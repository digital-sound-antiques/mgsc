...
The compression algorithm is a sort of [dictionay coder](https://en.wikipedia.org/wiki/Dictionary_coder), looks similar to  a little endian version of [lze](http://gorry.haun.org/pw/?lze) (lze is based on [lzexe](https://bellard.org/lzexe.html). Uncompress function is here: [uncompress.ts](https://github.com/digital-sound-antiques/mgsrc-js/blob/master/src/uncompress.ts).
